              ...
              <tbody>
                <tr>
                  <td>
                    {/* <input
                      type="checkbox"
                      checked={isChecked[boardno]}
                      onChange={(e) => handleCheck(e, boardno)}
                    /> */}
                  </td>
                  <td>123456789</td>
                  <td>홍길동</td>
                ...
                {noticeList &&
                  noticeList.map((item, idx) => (
                    <tr key={item.id}>
                      ...
                      <td>{item.department}</td> {/* 수정된 부분 */}
                      <td>{item.position}</td> {/* 수정된 부분 */}
                      <td>
                        {new Date(item.hireDate * 1000).toLocaleString()}
                      </td>{" "}
                      {/* 수정된 부분 */}
                    </tr>
                  ))}
